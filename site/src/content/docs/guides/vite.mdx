...
<Callout type="info">
**Using an AI coding agent?** Point it at our [`bootstrap-vite` skill](https://github.com/twbs/bootstrap/tree/main/skills/bootstrap-vite) to automate this setup. See [LLMs]([[docsref:/getting-started/llms]]) for all available skills.
</Callout>
