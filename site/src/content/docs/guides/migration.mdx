...
- **Removes all deprecated Sass variables and values:**
  ...
  - Consolidated carousel dark variables, removing `$carousel-dark-indicator-active-bg` and `$carousel-dark-control-icon-filter` for their reassigned counterparts. (Carousel captions were removed entirely—see the carousel changes below.)
