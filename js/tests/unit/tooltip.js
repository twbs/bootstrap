$(function () {
  ...
  QUnit.test('should place tooltips relative to placement option', function (assert) {
    ...
    $tooltip.on('shown.bs.tooltip', function () {
      assert.ok($('.tooltip')
          .is('.fade.bs-tether-element-attached-top.bs-tether-element-attached-center.show'),
  ...
  QUnit.test('should wait 200ms before hiding the tooltip', function (assert) {
    ...
    setTimeout(function () {
      ...
      }, 300) // 150ms delay + 150 default transition time of .fade
  ...
  QUnit.test('should correctly position tooltips on SVG elements', function (assert) {
    ...
    $circle
      .on('shown.bs.tooltip', function () {
        ...
        $circle.on('hidden.bs.tooltip', function () {
          assert.strictEqual($('.tooltip').length, 0, 'tooltip removed from dom')
          done()
        }).bootstrapTooltip('hide')
      })
