...
<ResizableExample code={`<nav class="navbar navbar-expand-md bg-1">
    <div class="container-fluid">
      ...
      <button class="btn btn-icon navbar-btn-icon" type="button" data-bs-toggle="offcanvas" data-bs-target="#navbarOffcanvas" aria-controls="navbarOffcanvas" aria-expanded="false" aria-label="Toggle navigation">
