...
<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="{% include placeholder.svg size="800x400" text="First slide" bg="#777" fg="#555" text_size="50" %}" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="{% include placeholder.svg size="800x400" text="Second slide" bg="#666" fg="#444" text_size="50" %}" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="{% include placeholder.svg size="800x400" text="Third slide" bg="#555" fg="#333" text_size="50" %}" alt="Third slide">
    </div>
  </div>
</div>
{% endcapture %}
