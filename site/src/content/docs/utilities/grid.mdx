...
Use `grid-cols-{value}` utilities to set the number of columns in a CSS Grid container by modifying the `--bs-columns` CSS variable. Bootstrap's CSS Grid system supports 1–6 column layouts out of the box.

<Example class="bd-example-cssgrid" code={`<div class="grid text-center grid-cols-1">
    <div>Column</div>
  </div>`} />

<Example class="bd-example-cssgrid" code={`<div class="grid text-center grid-cols-2">
    <div>Column</div>
    <div>Column</div>
  </div>`} />
...
<Example class="bd-example-cssgrid" code={`<div class="grid text-center grid-cols-5">
    <div>Column</div>
    <div>Column</div>
    <div>Column</div>
    <div>Column</div>
