...
Use `.theme-reset` when a nested subtree should drop the inherited theme and return to component defaults. See [Theme utility classes]([[docsref:/customize/theme#reset]]) for details.
