...
<div class="row bd-examples">
  ...
  <div class="col-6 col-md-4">
    <a href="{{ site.baseurl }}/examples/narrow-jumbotron/">
      <img class="img-thumbnail" src="{{ site.baseurl }}/examples/screenshots/narrow-jumbotron.png" alt="">
    </a>
...
<div class="row bd-examples">
  <div class="col-6 col-md-4">
    <a href="{{ site.baseurl }}/examples/navbars/">
      <img class="img-thumbnail" src="{{ site.baseurl }}/examples/screenshots/navbars.png" alt="">
    </a>
    <h4>Navbar</h4>
  ...
  <div class="col-6 col-md-4">
    <a href="{{ site.baseurl }}/examples/navbar-top/">
      <img class="img-thumbnail" src="{{ site.baseurl }}/examples/screenshots/navbar-top.png" alt="">
    </a>
  ...
  <div class="col-6 col-md-4">
    <a href="{{ site.baseurl }}/examples/navbar-top-fixed/">
      <img class="img-thumbnail" src="{{ site.baseurl }}/examples/screenshots/navbar-top-fixed.png" alt="">
    </a>
    <h4>Fixed navbar</h4>
