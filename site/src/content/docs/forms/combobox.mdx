...
Use the [form field]([[docsref:/forms/field]]) component to layout and wrap your combobox with a label, description, and validation feedback messages in a vertical stack.

<Example code={`<div class="form-field">
    <label for="exampleCombobox" class="form-label">Combobox</label>
