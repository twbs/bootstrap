...
Always set `width` and `height` attributes on the `<img>` to match the avatar size (the default is `40` for `2.5rem`). While `.avatar-img` constrains the rendered size with CSS, the HTML attributes let the browser reserve layout space before the CSS or image has loaded, which improves rendering performance and avoids layout shift.

<Example code={`<span class="avatar">
    <img class="avatar-img" src="https://github.com/mdo.png" alt="mdo" width="40" height="40">
  </span>`} />
...
<Example code={`<span class="avatar avatar-xs">
    <img class="avatar-img" src="https://github.com/mdo.png" alt="mdo" width="24" height="24">
  </span>
  <span class="avatar avatar-sm">
    <img class="avatar-img" src="https://github.com/mdo.png" alt="mdo" width="32" height="32">
  </span>
  <span class="avatar">
    <img class="avatar-img" src="https://github.com/mdo.png" alt="mdo" width="40" height="40">
  </span>
  <span class="avatar avatar-lg">
    <img class="avatar-img" src="https://github.com/mdo.png" alt="mdo" width="48" height="48">
  </span>
  <span class="avatar avatar-xl">
    <img class="avatar-img" src="https://github.com/mdo.png" alt="mdo" width="64" height="64">
  </span>`} />
...
<Example code={`<div class="avatar-stack">
    ...
    <span class="avatar">
      <img class="avatar-img" src="https://i.pravatar.cc/150?img=34" alt="User avatar" width="40" height="40">
    </span>
