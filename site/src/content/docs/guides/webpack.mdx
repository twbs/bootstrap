...
<Callout type="info">
**Using an AI coding agent?** Point it at our [`bootstrap-webpack` skill](https://github.com/twbs/bootstrap/tree/main/skills/bootstrap-webpack) to automate this setup. See [LLMs]([[docsref:/getting-started/llms]]) for all available skills.
</Callout>
