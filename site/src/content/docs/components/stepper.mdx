...
<Example code={`<ol class="stepper stepper-horizontal w-100">
    ...
    <li class="stepper-item theme-success active"><div><div>Confirm email</div><div class="badge badge-subtle theme-success">Complete</div></div></li>
    <li class="stepper-item active"><div><div>Update profile</div><div class="badge badge-subtle theme-primary">In-progress</div></div></li>
