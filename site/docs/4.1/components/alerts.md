...
| `_getInstance` | *Static* method which allow you to get the alert instance associate to a DOM element, you can use it like that : <code>bootstrap.Alert._getInstance(alert)</code> |
