...
Headings are sized with our responsive font-size root CSS variables. You can use these yourself, or with our heading classes, [font size utilities]([[docsref:/utilities/font-size]]), and [text utilities]([[docsref:/utilities/text]]) (where you’ll get a `line-height` as well).
