(function (global, factory) {
  ...
  (global.Tooltip = factory(global.Data,global.EventHandler,global.Manipulator,global.Popper,global.SelectorEngine,global.Util));
  ...
  function () {
    ...
    _proto.show = function show() {
      ...
      if (this.isWithContent() && this._isEnabled) {
        ...
        var isInTheDom = this.element.ownerDocument.documentElement.contains(this.element);
    ...
    _proto._setListeners = function _setListeners() {
      ...
      triggers.forEach(function (trigger) {
        if (trigger === 'click') {
          EventHandler.on(_this3.element, _this3.constructor.Event.CLICK, _this3.config.selector, function (event) {
            return _this3.toggle(event);
          });
        } else if (trigger !== Trigger.MANUAL) {
          var eventIn = trigger === Trigger.HOVER ? _this3.constructor.Event.MOUSEENTER : _this3.constructor.Event.FOCUSIN;
          var eventOut = trigger === Trigger.HOVER ? _this3.constructor.Event.MOUSELEAVE : _this3.constructor.Event.FOCUSOUT;
          EventHandler.on(_this3.element, eventIn, _this3.config.selector, function (event) {
            return _this3._enter(event);
          });
          EventHandler.on(_this3.element, eventOut, _this3.config.selector, function (event) {
    ...
    _proto._getConfig = function _getConfig(config) {
      if (typeof config !== 'undefined' && typeof config.container === 'object' && config.container.jquery) {
        config.container = config.container[0];
      }

      config = _objectSpread({}, this.constructor.Default, Manipulator.getDataAttributes(this.element), typeof config === 'object' && config ? config : {});
