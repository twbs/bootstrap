...
<table class="table table-bordered table-striped responsive-utilities table-responsive">
  ...
  <tbody>
    <tr>
      <th scope="row"><code>.hidden-down</code></th>
...
<div class="row responsive-utilities-test visible-on">
  <div class="col-6 col-sm-3">
    ...
    <span class="hidden-down not-visible">Extra small</span>
  </div>
  <div class="col-6 col-sm-3">
...
<div class="row responsive-utilities-test visible-on">
  <div class="col-6 col-sm-3">
    <span class="hidden-down visible">&#10004; Visible on small or wider</span>
...
<div class="row responsive-utilities-test visible-on">
  <div class="col-6 col-sm-4">
    ...
    <span class="hidden-down not-visible">Your viewport is NOT exactly extra small</span>
  </div>
  <div class="col-6 col-sm-4">
    <span class="hidden-down hidden-md-up visible">&#10004; Your viewport is exactly small</span>
