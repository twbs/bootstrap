...
<Example code={`<p class="text-balanced">This is a long paragraph written to show how the text-balanced of an element is affected by our utilities. Classes are applied to the element itself or sometimes the parent element. These classes can be customized as needed with our utility API.</p>`} />
