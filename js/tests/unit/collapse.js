$(function () {
  ...
  test('should remove "collapsed" class from target when collapse is shown', function () {
    ...
    var $target = $('<a data-toggle="collapse" href="#test1"></a>').appendTo('#qunit-fixture')
  ...
  test('should remove "collapsed" class from active accordion target', function () {
    ...
    var $target1 = $('<a data-toggle="collapse" href="#body1" data-parent="#accordion"></a>').appendTo($groups.eq(0))

    $('<div id="body1" class="in"></div>').appendTo($groups.eq(0))

    var $target2 = $('<a class="collapsed" data-toggle="collapse" href="#body2" data-parent="#accordion"></a>').appendTo($groups.eq(1))

    $('<div id="body2"></div>').appendTo($groups.eq(1))

    var $target3 = $('<a class="collapsed" data-toggle="collapse" href="#body3" data-parent="#accordion"></a>').appendTo($groups.eq(2))
