...
<section class="facet">
  <div class="facet-header">
    <a type="button" class="btn btn-link facet-toggle" data-toggle="collapse" href="#facetDefaultExample" aria-expanded="false" aria-controls="collapseExample">
...
<section class="facet">
  ...
  <div class="facet-body collapse show" id="facetSubCollapseExample">
    ...
    <a type="button" class="btn btn-link facet-toggle facet-toggle-more" data-toggle="collapse" href="#facetSubCollapseItem" aria-expanded="false" aria-controls="collapseExample">Show more</a>
  </div>
</section>
{% endcapture %}
{% include example.html content=example %}
