...
To change the pointer when hovered on a button use the cursor class. Use the following classes: 
...
<Example code={`
<button class="btn cursor-default" >Default pointer button</button>
<button class="btn cursor-pointer" >Default pointer button</button>
<button class="btn cursor-move" >Default pointer button</button>
<button class="btn cursor-not-allowed" >Default pointer button</button>
`} />
