...
- Restored 16px base font-size. All `rem`-based sizing throughout the framework has been recalibrated accordingly, including form controls, pagination, and chips.
