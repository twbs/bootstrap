(function (global, factory) {
  ...
  (global.Collapse = factory(global.Data,global.EventHandler,global.Manipulator,global.SelectorEngine,global.Util));
  ...
  function () {
    function Collapse(element, config) {
      ...
      var toggleList = SelectorEngine.find(Selector.DATA_TOGGLE);
    ...
    _proto._getParent = function _getParent() {
      ...
      var elements = Util.makeArray(SelectorEngine.find(selector, parent));
      elements.forEach(function (element) {
        return _this3._addAriaAndCollapsedClass(Collapse._getTargetFromElement(element), [element]);
      });
      return parent;
    };
