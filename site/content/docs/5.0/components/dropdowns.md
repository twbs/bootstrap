...
Historically dropdown menu contents *had* to be links, but that's no longer the case with v5. Now you can optionally use `<button>` elements in your dropdowns instead of just `<a>`s.
