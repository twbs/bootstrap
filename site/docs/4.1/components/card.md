...
<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="{% include placeholder.svg size="100%x180" %}" alt="Card image cap">
  <div class="card-body">
...
{% capture example %}
<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="{% include placeholder.svg size="100%x180" text="Image cap" %}" alt="Card image cap">
  <div class="card-body">
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
  </div>
</div>
...
<div class="card">
  ...
  <img class="card-img-bottom" src="{% include placeholder.svg size="100%x180" %}" alt="Card image cap">
</div>
{% endcapture %}
{% include example.html content=example %}
...
<div class="card bg-dark text-white">
  <img class="card-img" src="{% include placeholder.svg size="100%x270" text="Card image" %}" alt="Card image">
...
<div class="card-deck">
  <div class="card">
    <img class="card-img-top" src="{% include placeholder.svg size="100%x200" %}" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Card title</h5>
...
<div class="card-columns">
  <div class="card">
    <img class="card-img-top" src="{% include placeholder.svg size="100%x160" %}" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card">
    <img class="card-img" src="{% include placeholder.svg size="100%x260" %}" alt="Card image">
  </div>
