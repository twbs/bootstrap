...
- [FrontendAtlas: Modal Accessibility Diagnostic Scenario](https://frontendatlas.com/incidents/modal-screen-reader-failure) — An applied behavioral exercise covering dialog naming, focus containment, background isolation, and focus restoration.
