$(function () {
    ...
    module("bootstrap-offcanvas")
      ...
      test("should not activate if toggler is disabled", function () {
        var offcanvasHTML = '<div class="row row-offcanvas row-offcanvas-right">'
          + '<div class="span9">'
          + '<p class="visible-phone"><button disabled href="#sidebar" class="btn btn-offcanvas" data-toggle="offcanvas">More</button></p>'
          + '<p>Lorem ipsum</p>'
          + '</div>'
      ...
      test("should not activate if toggler is disabled", function () {
        var offcanvasHTML = '<div class="row row-offcanvas row-offcanvas-right">'
          + '<div class="span9">'
          + '<p class="visible-phone"><button href="#sidebar" class="disabled btn btn-offcanvas" data-toggle="offcanvas">More</button></p>'
          + '<p>Lorem ipsum</p>'
          + '</div>'
          + '<nav class="span3 sidebar-offcanvas sidebar-offcanvas-right" id="sidebar" role="navigation">'
          + '<p>Off Canvas Sidebar</p>'
