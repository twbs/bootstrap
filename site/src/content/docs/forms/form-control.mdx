...
Use `.form-ghost` to remove all default input styling when your wrapper handles spacing, border, and focus styles. This is useful for custom composites like search bars and command inputs.
