$(function () {
    ...
    module("collapse")
      ...
      test("should add custom class to target .panel-heading when collapse shown", function () {
        $.support.transition = false
        stop()
        ...
        var collapsible = $('<div class="panel-collapse collapse" id="collapseOne"><div class="panel-body"></div></div>')
          ...
          .on('show.bs.collapse', function () {
            ok(!target.hasClass('collapsed'))
            ok(panel.find('.panel-heading').hasClass('custom-class1'))
            start()
          })
      ...
      test("should remove custom class to target .panel-heading when collapse shown", function () {
        $.support.transition = false
        stop()
