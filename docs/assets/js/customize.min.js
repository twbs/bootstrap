...
},a,b),m(b)},v.refreshStyles=m,v.Parser.fileLoader=r,v.refresh("development"===v.env),"function"==typeof define&&define.amd&&define(function(){return v})}(window);var JSZip=function(a,b){this.files={},this.root="",a&&this.load(a,b)};/*! @source http://purl.eligrey.com/github/Blob.js/blob/master/Blob.js */
