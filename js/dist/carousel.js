(function (global, factory) {
  ...
  (global.Carousel = factory(global.Data,global.EventHandler,global.Manipulator,global.SelectorEngine,global.Util));
    ...
    _proto._addEventListeners = function _addEventListeners() {
      ...
      if (this._config.pause === 'hover') {
        ...
        if ('ontouchstart' in document.documentElement) {
          ...
          EventHandler.on(this._element, Event.TOUCHEND, function () {
            _this2.pause();
    ...
    _proto._slide = function _slide(direction, element) {
      ...
      if (this._element.classList.contains(ClassName.SLIDE)) {
        ...
        EventHandler.one(activeElement, Util.TRANSITION_END, function () {
          ...
          setTimeout(function () {
            EventHandler.trigger(_this3._element, Event.SLID, {
