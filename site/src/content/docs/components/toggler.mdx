---
title: Toggler
description: The Toggler plugin allows you to toggle attributes or classes using simple HTML markup.
toc: true
---
...
<div class="card mt-2" data-bs-toggle="toggler" data-bs-value="fg-danger" data-bs-attribute="class">
