...
2. **Include Bootstrap’s CSS and JS.** Place the `<link>` tag in the `<head>` for our CSS, and the `<script>` tag for our JavaScript bundle (including Popper for positioning dropdowns, popovers, and tooltips) before the closing `</body>`. Learn more about our [CDN links](#cdn-links).
   ...
   You can also include [Popper](https://github.com/floating-ui/popper-docs/blob/main/docs/v2/index.md) and our JS separately. If you don’t plan to use dropdowns, popovers, or tooltips, save some kilobytes by not including Popper.
...
- Dropdowns for displaying and positioning (also requires [Popper](https://github.com/floating-ui/popper-docs/blob/main/docs/v2/index.md))
...
- Tooltips and popovers for displaying and positioning (also requires [Popper](https://github.com/floating-ui/popper-docs/blob/main/docs/v2/index.md))
