...
**Physical placements:** `top`, `bottom`, `left`, `right` — these are fixed directions regardless of text direction.

**Logical placements:** `start`, `end` — these automatically flip based on RTL. In LTR mode, `start` becomes `left` and `end` becomes `right`. In RTL mode, they swap.

All placements support optional `-start` and `-end` alignment modifiers (e.g., `bottom-start`, `end-end`).

<Callout>
**Use logical placements for RTL support.** Use `start` and `end` instead of `left` and `right` for menus that need to work correctly in both LTR and RTL layouts.
</Callout>
...
Use `start`, `start-start`, or `start-end` for RTL-aware horizontal placement. In LTR, this positions the menu to the left; in RTL, it positions to the right.

<Example class="d-flex gap-2" code={`<div class="dropdown">
    <button class="btn btn-solid theme-secondary" type="button" data-bs-toggle="dropdown" data-bs-placement="start-start" aria-expanded="false">
      Start start
    </button>
    <ul class="dropdown-menu">
      <li><a class="dropdown-item" href="#">Action</a></li>
  ...
  <div class="dropdown">
    <button class="btn btn-solid theme-secondary" type="button" data-bs-toggle="dropdown" data-bs-placement="start" aria-expanded="false">
      Start
    </button>
    <ul class="dropdown-menu">
      <li><a class="dropdown-item" href="#">Action</a></li>
  ...
  <div class="dropdown">
    <button class="btn btn-solid theme-secondary" type="button" data-bs-toggle="dropdown" data-bs-placement="start-end" aria-expanded="false">
      Start end
    </button>
    <ul class="dropdown-menu">
      <li><a class="dropdown-item" href="#">Action</a></li>
...
Use `end`, `end-start`, or `end-end` for RTL-aware horizontal placement. In LTR, this positions the menu to the right; in RTL, it positions to the left.

<Example class="d-flex gap-2" code={`<div class="dropdown">
    <button class="btn btn-solid theme-secondary" type="button" data-bs-toggle="dropdown" data-bs-placement="end-start" aria-expanded="false">
      End start
    </button>
    <ul class="dropdown-menu">
      <li><a class="dropdown-item" href="#">Action</a></li>
  ...
  <div class="dropdown">
    <button class="btn btn-solid theme-secondary" type="button" data-bs-toggle="dropdown" data-bs-placement="end" aria-expanded="false">
      End
    </button>
    <ul class="dropdown-menu">
      <li><a class="dropdown-item" href="#">Action</a></li>
  ...
  <div class="dropdown">
    <button class="btn btn-solid theme-secondary" type="button" data-bs-toggle="dropdown" data-bs-placement="end-end" aria-expanded="false">
      End end
    </button>
    <ul class="dropdown-menu">
      <li><a class="dropdown-item" href="#">Action</a></li>
