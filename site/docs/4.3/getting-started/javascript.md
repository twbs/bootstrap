...
layout: docs
title: JavaScript
description: Bring Bootstrap to life with our optional JavaScript plugins built on VanillaJS. Learn about each plugin, our data and programmatic API options, and more.
