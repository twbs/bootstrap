$(function () {
    ...
    module("collapse")
      ...
      test("should add custom class to target .panel when collapse shown", function () {
        ...
        var target = $('<a data-toggle="collapse" href="#collapseOne" class="collapsed" data-parent="#accordion" data-class="panel-success"></a>')
        ...
        var collapsible = $('<div class="panel-collapse collapse" id="collapseOne"><div class="panel-body"></div></div>')
          ...
          .on('shown.bs.collapse', function () {
            ok(!target.hasClass('collapsed'))
            ok(panel.hasClass('panel-success'))
            ok(panel.hasClass('active'))
            start()
          })
      ...
      test("should remove custom class to target .panel when collapse shown", function () {
        ...
        var panel = $('<div class="panel panel-default panel-success active"><div class="panel-heading"><h4 class="panel-title"></h4></div></div>')
          .appendTo(accordion.find('.accordion-group'))

        var target = $('<a data-toggle="collapse" href="#collapseOne" data-parent="#accordion" data-class="panel-success"></a>')
          .appendTo(accordion.find('.panel-title'))
