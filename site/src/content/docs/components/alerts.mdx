...
```
> **Tip:** You can customize alert styles and animations using Bootstrap's SCSS variables. Check the `_variables.scss` file for more!

## Using the alert JavaScript plugin
