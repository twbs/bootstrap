...
import {
  cssCdn, docsVersion, jsBundleCdn, jsSnippetFile, jsColorModeFile
...
`
  ...
  const jsColorModeContent = `document.querySelector('body').innerHTML += \`<!-- Dark mode toggle -->
  ...
  const project = {
    files: {
      ...
      'bootstrap-color-mode/color-mode.js': jsColorModeContent
    },
