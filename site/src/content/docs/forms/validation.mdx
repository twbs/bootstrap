...
We use one large mixin, `form-validation-state`, to generate all validation feedback styles from a state name and theme color. This mixin is called through [a Sass loop](#sass-loops) to compile the CSS.
