 ...
 */
!function(e,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t():"function"==typeof define&&define.amd?define(t):e.bsCustomFileInput=t()}(this,function(){"use strict";var d={CUSTOMFILE:'.custom-file input[type="file"]',CUSTOMFILELABEL:".custom-file-label",FORM:"form",INPUT:"input"},r=function(e){if(0<e.childNodes.length)for(var t=[].slice.call(e.childNodes),n=0;n<t.length;n++){var r=t[n];if(3!==r.nodeType)return r}return e},s=function(e){var t=e.bsCustomFileInput.defaultText,n=e.parentNode.querySelector(d.CUSTOMFILELABEL);n&&(r(n).innerHTML=t)},t=!!window.File,n=function(e){return e.hasAttribute("multiple")&&t?[].slice.call(e.files).map(function(e){return e.name}).join(", "):e.value};function f(){var e=this.parentNode.querySelector(d.CUSTOMFILELABEL);e&&(r(e).innerHTML=n(this))}function A(){for(var e=[].slice.call(this.querySelectorAll(d.INPUT)).filter(function(e){return!!e.bsCustomFileInput}),t=0,n=e.length;t<n;t++)s(e[t])}var p="bsCustomFileInput",g="reset",m="change";return{init:function(e,t){void 0===e&&(e=d.CUSTOMFILE),void 0===t&&(t=d.FORM);for(var n,r,i,o=[].slice.call(document.querySelectorAll(e)),a=[].slice.call(document.querySelectorAll(t)),s=0,l=o.length;s<l;s++){var c=o[s];Object.defineProperty(c,p,{value:{defaultText:(n=c,r=void 0,void 0,r="",i=n.parentNode.querySelector(d.CUSTOMFILELABEL),i&&(r=i.innerHTML),r)},writable:!0}),c.addEventListener(m,f)}for(var u=0,h=a.length;u<h;u++)a[u].addEventListener(g,A),Object.defineProperty(a[u],p,{value:!0,writable:!0})},destroy:function(){for(var e=[].slice.call(document.querySelectorAll(d.FORM)).filter(function(e){return!!e.bsCustomFileInput}),t=[].slice.call(document.querySelectorAll(d.INPUT)).filter(function(e){return!!e.bsCustomFileInput}),n=0,r=t.length;n<r;n++){var i=t[n];s(i),i[p]=void 0,i.removeEventListener(m,f)}for(var o=0,a=e.length;o<a;o++)e[o].removeEventListener(g,A),e[o][p]=void 0}}});
/*!
