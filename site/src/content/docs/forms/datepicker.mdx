...
import { motion } from 'vanilla-calendar-pro'

Datepicker.registerExtensions(motion)
```

After you register them, the options work through data attributes too:

```html
<div data-bs-toggle="datepicker" data-bs-inline="true" data-bs-vcp-options='{"animation": true, "enableSwipe": true}'></div>
```
