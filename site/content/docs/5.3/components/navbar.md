...
Navbar will require the Bootstrap JavaScript bundle for the following functionality:
- Extending Bootstrap Collapse and Offcanvas plugins to implement responsive behaviors
