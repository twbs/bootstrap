...
<Example class="d-grid grid md:grid-cols-2" code={getData('theme-colors').map((themeColor) => `<div class="card theme-${themeColor.name}">
...
<Example class="bg-dark" code={`<div class="card card-translucent" style="width: 18rem;">
    <div class="card-body">
