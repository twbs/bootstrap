...
Use the included `.figure` , `.figure-img` and `.figure-caption` classes to provide some baseline styles for the HTML5 `<figure>` and `<figcaption>` elements. You will have to add the `.img-fluid` class to your `img` to make it responsive.
