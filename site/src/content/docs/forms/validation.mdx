...
- Custom validation states beyond `valid`/`invalid` (e.g., `warning`) are supported via the `.is-*` class pattern and the `$validation-states` Sass map.
...
<Example code={`<form class="row g-4 mx-auto" data-bs-validate novalidate>
    <div class="form-field md:col-6">
      <label for="validationCustom01" class="form-label">Name</label>
      <input type="text" class="form-control" id="validationCustom01" value="Mark Otto" required>
      ...
      <div class="input-group">
        ...
        <input type="number" class="form-control" value="100" id="validationCustomUsername" aria-describedby="inputGroupPrepend" required>
      </div>
      <div class="valid-feedback">Amazing, thank you!</div>
    ...
    <div class="form-field">
      ...
      <input type="text" class="form-control" id="validationCustomAddress" value="1234 Main St" required>
      <div class="invalid-feedback">Please enter a valid mailing address.</div>
    </div>
    <div class="form-field md:col-6">
    ...
    <button class="btn-solid theme-primary w-auto" type="submit">Submit form</button>
  </form>`} />
