...
You can also use inline sizes alone with avatars instead of using a size modifier class.

<Example code={`<span class="avatar">
    <img class="avatar-img" src="https://github.com/mdo.png" alt="mdo" width="128" height="128">
  </span>`} />
